// lr1.cpp: определ¤ет точку входа дл¤ консольного приложени¤.
//
...
int main(int argc, char* argv[])
{
	...
	if (proc_n == 0)
	{
		...
		for (int dim = 0; dim < 7; dim++)
		{
			...
			t2 = __rdtsc();
			posl_res[0][dim] = (double)(t2 - t1) / 1700000000;
		}
		...
		for (int dim = 0; dim < 7; dim++)
		{
			...
			t2 = __rdtsc();
			posl_res[1][dim] = (double)(t2 - t1) / 1700000000;
		}
		...
		for (int dim = 0; dim < 7; dim++)
		{
			...
			t2 = __rdtsc();
			posl_res[2][dim] = (double)(t2 - t1) / 1700000000;
		}
